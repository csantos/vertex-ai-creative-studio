...
You have three deployment options for this application:
...
2. [Deploy using the autogenerated Cloud Run Domain and Access Restricted Using IAP](#deploying-using-cloud-run-domain). Use this if:
...
3. [Deploy using the autogenerated Cloud Run Domain and Public Access (No Authentication)](#deploy-using-cloud-run-domain-and-allow-public-access-no-authentication). Use this if:
   * You accept the risk of allowing unauthenticated access to the GenMedia application. Any user will be able to view and use your instance to modify your library and create new images / videos. You are accepting responsibility of any billing that may occur in this configuration
   * You can not create a DNS entry
...
## Deploy using Cloud Run Domain and Allow Public Access (No Authentication)

This is NOT a recommended deployment option. You accept the risk of allowing unauthenticated access to the GenMedia application. Any user will be able to view and use your instance to modify your library and create new images / videos. You are accepting responsibility of any billing that may occur in this configuration. 

With this configuration any user can access the autogenerated Cloud Run domain. 
